...
export const pt = {
  ...
  missao: {
    ...
    tabelas: 'tabelas',
    colunas: 'Colunas:',
    // "Prévia": mostra as 5 primeiras linhas no Resultado; a dica diz isso.
    botaoPrevia: 'Prévia',
    dicaPrevia: 'Ver as 5 primeiras linhas da tabela',
  ...
  // O laboratório: a base inteira, para consultas livres (passo 17).
  laboratorio: {
    titulo: 'Laboratório',
    avisoCelular: 'O laboratório funciona melhor num computador, com teclado. Dá para consultar daqui, mas escrever SQL no celular é difícil.',
    abas: {
      tabelas: 'Tabelas',
      historico: 'Histórico',
      favoritas: 'Favoritas',
    },
    comece: 'Escreva uma consulta e rode com {atalho}. As tabelas da base estão à esquerda: um clique escreve o nome no editor.',
    importar: 'Importar CSV',
    importado: 'Tabela {nome} criada, com {n} linhas. Ela fica só nesta visita: some ao recarregar a página.',
    importarErro: 'Não deu para ler {arquivo} como CSV.',
    grandeDemais: 'O arquivo passa de 50 MB: grande demais para o navegador.',
    importada: 'importada',
    criadaAqui: 'criada aqui',
    usarTabela: 'Usar tabela',
    zerar: 'Zerar a base',
    zerarConfirma: 'Zerar mesmo? O que foi criado ou alterado aqui some (as importadas voltam).',
    zerada: 'Base zerada.',
    historicoVazio: 'As consultas que rodarem aparecem aqui — as 50 últimas.',
    favoritasVazio: 'Marque uma consulta com a estrela para guardá-la aqui.',
    remover: 'Tirar das favoritas',
    favoritar: 'Guardar nas favoritas',
    desfavoritar: 'Tirar das favoritas',
    guardada: 'Guardada nas favoritas.',
    tirada: 'Tirada das favoritas.',
    link: 'Copiar o link com esta consulta',
    linkCopiado: 'Link copiado.',
    semCopiar: 'O navegador não deixou copiar.',
    copiar: 'Copiar',
    copiarTitulo: 'Copiar como tabela (cola direto numa planilha)',
    copiado: 'Copiado: {n} linhas.',
    baixar: 'Baixar CSV',
    baixado: 'CSV baixado.',
    baixadoCortado: 'CSV baixado, com as primeiras {n} linhas.',
    formato: 'Formato do CSV',
    formatoBr: 'Excel (Brasil)',
    formatoInt: 'Internacional',
  },
