...
export const pt = {
  ...
  inicio: {
    ...
    atalhos: {
      ...
      cola: 'Dicas',
      colaDescricao: 'A sintaxe por cláusula, as funções e as tabelas da base.',
      jogos: 'Jogos',
      jogosDescricao: 'Palpite, Telegrama e Infiltrado: SQL em partidas curtas.',
    },
  },

  // As Dicas (a antiga cola): a sintaxe, as funções e a base (passo 18).
  cola: {
    titulo: 'Dicas',
    subtitulo: 'A sintaxe, as funções e a base, para consultar enquanto você escreve.',
    indice: 'Nesta página',
    secoes: {
      sintaxe: 'Sintaxe',
      funcoes: 'Funções',
      ...
      outrosBancos: 'Em outros bancos',
      glossario: 'Glossário',
    },
    abrirNoLaboratorio: 'Abrir no laboratório',
    funcao: 'Função',
    oQueFaz: 'O que faz',
    exemplo: 'Exemplo',
    ajudaSintaxe: 'Abra um grupo para ver os comandos. O ícone no canto da consulta abre ela no laboratório.',
    ajudaFuncoes: 'Passe o mouse — ou toque — na linha para ver o exemplo.',
    ajudaIndicadores: 'Passe o mouse na linha para ver o que o indicador mede.',
    mapaTexto: 'Escolha de onde vêm os dados, clique numa tabela e veja as colunas ao lado. As tabelas ligadas acendem na lateral da coluna que faz a ligação.',
    origem: 'Origem dos dados',
    grupos: {
      mundo: 'Dados do Banco Mundial',
      instituto: 'Dados do Instituto (fictícios)',
    },
    escolhaTabela: 'Escolha uma tabela na lista ao lado.',
    tipo: 'Tipo',
    oQueE: 'O que é',
    chavePrimaria: 'chave primária',
    ligacao: 'Ligação',
    indicadoresTexto: 'Cada indicador é uma coluna de `pais_ano` e, no formato longo, um `codigo_indicador` de `valores_indicadores`. A unidade de cada um está na tabela `indicadores`.',
    coluna: 'Coluna',
    indicador: 'Indicador',
    codigoBanco: 'Código no Banco Mundial',
    oQueMede: 'O que mede',
    temas: {
      sociedade: 'População e sociedade',
      economia: 'Economia',
      saude: 'Saúde',
      energia: 'Energia e clima',
      digital: 'Digital',
    },
    outrosTexto: 'O SQL muda pouco de um banco para outro, mas alguns detalhes mudam. A sintaxe antiga do Oracle ainda aparece em sistemas mais velhos.',
    pedido: 'Pedido',
    esteSite: 'DuckDB (este site)',
    antigo: 'antigo:',
    ...
    atalhosLista: {
      rodar: 'Rodar a consulta',
      comentar: 'Comentar ou descomentar as linhas',
      formatar: 'Formatar a consulta',
      recuar: 'Recuar ou desrecuar',
      sugestoes: 'Escolher uma sugestão do autocompletar',
      sair: 'Sair do editor pelo teclado',
    },
  },
  ...
  erros: {
    ...
    pistaVerTabelas: 'Confira o nome da tabela: as 11 tabelas da base estão nas Dicas.',
